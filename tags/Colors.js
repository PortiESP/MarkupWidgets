...
const Purple = props => <span style={{color: "purple"}}>{props.children}</span>
const Pink = props => <span style={{color: "pink"}}>{props.children}</span>
const Gray = props => <span style={{color: "gray"}}>{props.children}</span>
const White = props => <span style={{color: "white"}}>{props.children}</span>
